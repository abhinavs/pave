...
directly in a test with a real session. It follows the AGENTS.md job
contract exactly: it receives an id, not an ORM object, and the session is
a parameter rather than something the job opens for itself.
"""
